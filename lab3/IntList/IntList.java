...
public class IntList {
    ...
    public static void main(String[] args) {
        ...
        //IntList first = IntList.of(1, 3, 5);
        //IntList second = IntList.of(7, 9);
        //IntList result1 = IntList.dcatenate(first, second);



        IntList front = IntList.of(2, 4, 6);
        IntList back = IntList.of(8, 10);
        IntList result2 = IntList.catenate(front, back);
    }
